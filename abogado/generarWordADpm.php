...
$documento = "templates/adjudicacionPM7000.docx";
...
$templateProcessor->setValue('funLegal', $fundamentoLegal);
...
if (mysqli_num_rows($checkConexion) > 0) {
    ...
    echo $update = "UPDATE `impresion_ad` SET `fecha_oficio`='$fechaOficioSQL',`dom_prestador`='$domPrestador',`vig1`='$vigencia1SQL',`vig2`='$vigencia2SQL',`fundamento_legal`='$fundamentoLegalAtribuciones',`nombre_subdir_fov`='$subdirFov',`escritura_pub`='',`fecha_esc_pub`='',`nombre_notario`='',`num_notario`='',`fun_legal`='$fundamentoLegal' WHERE id_contrato='$iddecontrato'";
